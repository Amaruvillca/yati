                    ...
                    <div class="card-body">
                        ...
                        <form action="procesar_creacion_juego.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group" style="display: none;" >
                                ...
                                <input type="url" id="url_juego" name="url_juego" class="form-control" value="https://www.ejemplo.com/juego-matematicas"  required>
                            </div>
                            <div class="form-group">
                                <label for="edad_juego">Edad recomendada:</label>
                                <input type="number" id="edad_juego" name="edad_juego" class="form-control" min="5" max="10" step="1" required>
                            </div>
                            <div class="form-group">
