                ...
                <section class="col-lg-6 col-md-6 col-sm-12 col-12 lo">
                    <div class="regisrto">
                        <div class="formulario">
                                    ...
                                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            if ($conn->query($sql) === TRUE) {
                                                ...
                                                $message = 'Para restablecer tu contraseña, haz clic en el siguiente enlace: http://tudominio.com/restablecer.php?token=' . $token;
                            ...
                            <div class="invitado">
                                <p><a href="guardarContraseña.html">Ingresar como invitado</a></p>
                            </div>
                        </div>
